...
the contents of the control file renders either contour images from
querydata, or maps from shapefiles.
...
See also [Projection descriptions in Smartmet](https://github.com/fmidev/smartmet-qdtools/wiki/projection-descriptions-in-SmartMet)
